...
void create_screen_ui_player() {
    ...
    lv_obj_add_event_cb(obj, action_screen_pressed, LV_EVENT_PRESSED, (void *)0);
    lv_obj_add_event_cb(obj, action_gesture_page, LV_EVENT_GESTURE, (void *)0);
    lv_obj_remove_flag(obj, LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_SNAPPABLE|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0x0f0f0f), LV_PART_MAIN | LV_STATE_PRESSED);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    objects.icon_previous = obj;
                    lv_obj_set_pos(obj, 19, 5);
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_image_set_src(obj, &img_skip_back);
                }
            }
        }
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0x0f0f0f), LV_PART_MAIN | LV_STATE_PRESSED);
            {
                lv_obj_t *parent_obj = obj;
                {
                    // icon_next
                    lv_obj_t *obj = lv_image_create(parent_obj);
                    objects.icon_next = obj;
                    lv_obj_set_pos(obj, 19, 5);
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_image_set_src(obj, &img_skip_forward);
                }
            }
        }
        {
        ...
        }
        {
            ...
            lv_obj_set_style_width(obj, 358, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    // track_text
        ...
        }
        {
            ...
            lv_obj_remove_flag(obj, LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ON_FOCUS);
